...
namespace UserInterface {
    ...
    [CustomEditor(typeof(GMInputField), true)]
    public class GMInputFieldEditor : SelectableEditor {
        ...
        public override void OnInspectorGUI() {
            ...
            using (new EditorGUI.DisabledScope(m_TextComponent == null || m_TextComponent.objectReferenceValue == null)) {
                ...
                if (!m_ContentType.hasMultipleDifferentValues) {
                    ...
                    if (m_ContentType.enumValueIndex == (int)GMInputField.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)GMInputField.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)GMInputField.ContentType.Custom)
                        EditorGUILayout.PropertyField(m_LineType);

                    if (m_ContentType.enumValueIndex == (int)GMInputField.ContentType.Custom) {
