...
{
    [CustomEditor(typeof(GMScrollRect), true)]
    [CanEditMultipleObjects]
    public class GMScrollRectEditor : Editor
    {
        ...
        SerializedProperty m_StickToBottom;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_StickToBottom         = serializedObject.FindProperty("m_StickToBottom");
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((GMScrollRect)target).transform;
                ...
                if (m_HorizontalScrollbar.objectReferenceValue == null || ((GMScrollbar)m_HorizontalScrollbar.objectReferenceValue).transform.parent != transform)
                    m_HScrollbarIsNotChild = true;
                if (m_VerticalScrollbar.objectReferenceValue == null || ((GMScrollbar)m_VerticalScrollbar.objectReferenceValue).transform.parent != transform)
