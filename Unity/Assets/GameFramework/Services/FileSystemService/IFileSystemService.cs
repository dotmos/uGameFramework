...
namespace Service.FileSystem {
    public interface IFileSystemService : IFBSerializable,IService {
 ...
 /// </summary>
    ...
    public enum FSDomain {
        Scripting,RuntimeAssets,DevUIViews,DevUIViewsArchieve,ConfigFolder,SaveGames,Localizations
