	...
	public abstract partial class Node : ScriptableObject
	{
		...
		protected internal void InitBase () 
		{
			...
			if (String.IsNullOrEmpty (name))
				name = UnityEditor.ObjectNames.NicifyVariableName (GetNodeID);
			#endif
		...
		/// </summary>
		public abstract string GetNodeID { get; }
        ...
        /// <summary>
        /// Callback when the NodeInput was removed from the node
        /// </summary>
        protected internal virtual void OnRemoveInputConnection(NodeInput input) { }

        /// <summary>
        /// Callback when the NodeOutput was removed from the noode
        /// </summary>
        protected internal virtual void OnRemoveOutputConnection(NodeOutput output) { }

        /// <summary>
        /// Final say for the node if a NodeOutput is allowed to connect
        /// </summary>
        /// <param name="output"></param>
        /// <returns></returns>
        protected internal virtual bool CanApplyConnection(NodeOutput output) { return true; }
        ...
        /// <summary>
        /// Creates and output on this Node of the given type at the specified NodeSide and position and adds it to a knobGroup
        /// </summary>
        public NodeOutput CreateOutput(string outputName, string outputType, NodeSide nodeSide, float sidePosition, String knobGroup) {
            NodeOutput knob = NodeOutput.Create(this, outputName, outputType, nodeSide, sidePosition);
            knob.SetGroup(knobGroup);
            return knob;
        }
        /// <summary>
		...
		// -- INPUTS --
        /// <summary>
        /// Creates and input on this Node of the given type at the specified NodeSide and position and add it to a knobGroup
        /// </summary>
        public NodeInput CreateInput(string inputName, string inputType, NodeSide nodeSide, float sidePosition, String knobGroup) {
            NodeInput knob = NodeInput.Create(this, inputName, inputType, nodeSide, sidePosition);
            knob.SetGroup(knobGroup);
            return knob;
        }
