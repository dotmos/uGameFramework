...
namespace NodeEditorFramework 
{
	...
	public partial class NodeKnob : ScriptableObject
	{
		...
		/// <summary>
		/// Replaces all references to any ScriptableObjects this NodeKnob holds with the cloned versions in the serialization process.
		/// </summary>
		...
		public virtual void DrawKnob () 
		{
            if (isVisible) {
                ...
                GUI.Label(knobRect,new GUIContent("",name));
            }
        }
