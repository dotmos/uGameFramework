...
namespace NPBehave
{
    public class NPAction : Task
    {
        ...
        public NPAction(System.Action action) : base("Action")
        {
            this.action = action;
        }

        public NPAction(System.Func<bool, Result> multiframeFunc) : base("Action")
        {
            this.multiFrameFunc = multiframeFunc;
        }

        public NPAction(System.Func<Request, Result> multiframeFunc2) : base("Action")
        {
            this.multiFrameFunc2 = multiframeFunc2;
        }


        public NPAction(System.Func<bool> singleFrameFunc) : base("Action")
        {
